...
export const seedNewsArticles: NewsArticle[] = [
  {
    ...
    eyecatch: {
      ...
      alt: "U⇔U 事前登録開始・公式アカウント開設記念「えらべるPay®」プレゼントキャンペーン"
    },
    seo: {
    ...
    body: [
      ...
      },
      {
        id: "winner-2",
        type: "p",
        text: "DMを受信できる設定へ変更のうえご応募ください。一定期間ご返信がない場合は、当選を無効とさせていただく場合があります。"
      },
      ...
      { id: "pay-about-heading", type: "h2", text: "「えらべるPay®」について" },
      {
        id: "pay-about-1",
        type: "p",
        text: "「えらべるPay®」は、ポイントやPay系の商品を自由に選べるギフトです。\nラインナップの中から好きな商品と交換していただけます。"
      },
      {
        id: "pay-about-2",
        type: "p",
        text: "「えらべるPay®」の利用に専用アプリのダウンロードや会員登録は必要ありません。"
      },
      { id: "pay-notes-heading", type: "h2", text: "「えらべるPay®」ご利用上の注意" },
      {
        id: "pay-notes",
        type: "note",
        title: "株式会社ギフティのクリエイティブガイドラインに基づく注意事項",
        items: [
          "ラインナップの中から好きな商品と交換していただけます。",
          "ポイント数は受け取ったチケット券面をご確認ください。",
          "ラインナップおよび交換に必要なポイントは付与されたギフトにより異なり、変更になる場合があります。",
          "ポイント交換レートは商品により異なります。",
          "選択された商品によって、1ポイントにつき1円相当とならない場合があります。また、交換レートを含む商品の内容は今後予告なく変更となる場合があります。",
