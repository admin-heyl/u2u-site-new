...
export const metadata: Metadata = {
  ...
  description:
    "U⇔Uのアカウント削除および関連データ削除のリクエスト方法、削除対象データ、保持される場合があるデータについてご案内します。",
  openGraph: {
    title: "アカウント削除について | U⇔U",
    description:
      "U⇔Uのアカウント削除および関連データ削除のリクエスト方法をご案内します。",
    url: "/account-delete"
  }
};
    ...
    <main>
      ...
      <article className="legal-body">
        <p className="legal-lead">
          このページでは、合同会社 HEYL が提供する「U⇔U（ユーーズ）」のアカウント削除および関連データ削除のリクエスト方法をご案内します。
        </p>

        <section className="account-delete-request">
          <h2>アカウント削除をリクエストする</h2>
          <p>
            U⇔Uのアカウント削除を希望される場合は、以下のメールリンクからご連絡ください。
